...
public abstract class Order {
	...
	private static JSONModule jmodule = new JSONModule();
	
	public static Order parseOrder(String jstring) throws ParseException{
		
		return jmodule.parseOrder(jstring);
	}
	
	public static Response parseResponse(String jstring) throws ParseException{
		
		return jmodule.parseResponse(jstring);
	}
